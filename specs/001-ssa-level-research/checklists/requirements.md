...
- Updated on 2026-09-12: added the user-requested preliminary M0 gate, a P0 scenario, FR-018 through FR-020 and SC-008. Specification completeness is distinct from runtime acceptance: M0 was PARTIAL in `docs/mcp/dolphin-mcp.md` and blocked SSA implementation.
