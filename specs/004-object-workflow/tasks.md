...
- [ ] T010 [US2] Read-only external catalogue and per-level provenance in src/editor/import-catalog.mjs (FR011).
...
- [ ] T016 [US3] Extend to Mining then to another family and the matrix docs/level-entry-status.json; no silent fallback (FR013/SC005).
