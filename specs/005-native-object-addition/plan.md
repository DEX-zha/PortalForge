...
Priorité ennemis/loot : comparer les instances partageant déjà script/ID ; distinguer paramètres propres, variables d'exécution et références partagées légitimes. Témoins à positions fixes hors de l'apparition du joueur, puis copie bornée de l'état au retour du factory dans la mémoire réservée Gecko. Pas de GDB ni trace de chaque frame. Modifier une seule condition causale à la fois, documenter les échecs et confirmer une recette avant son activation dans Project.
