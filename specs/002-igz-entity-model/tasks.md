...
- [X] T015 [US1] Decode the section-1 header and the 2 866-entry list (research.md R4) in `src/igz/refs.mjs`; document the flagged-pointer meaning as a finding (LIKELY or UNKNOWN) with the tested hypotheses (findings `igz.section1.header-table`, `igz.flagged-word.global-handle`; 2026-09-13)
