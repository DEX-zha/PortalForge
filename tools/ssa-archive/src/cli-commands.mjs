...
export const commands = {
  ...
  async igz(pos, o) {
    ...
    if (sub === 'clone-entity') {
      ...
      const r = R.planReachableClone(buf, fixups, { start: Number(need(pos[2], 'owner offset')), end: Number(need(o.end, 'end')), findingId: need(o.finding, 'finding'), edits, register: !o['no-register'], replaceEntry: o['replace-entry'] !== undefined ? Number(o['replace-entry']) : null, freshIds: !!o['fresh-ids'], extraFindings: o['also-finding'] ?? [] });
