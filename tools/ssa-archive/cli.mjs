...
const options = {
  ...
  end: { type: 'string' }, fixups: { type: 'string', multiple: true }, 'no-register': { type: 'boolean', default: false }, probe: { type: 'string', multiple: true }, 'also-finding': { type: 'string', multiple: true }, 'fresh-ids': { type: 'boolean', default: false }, regions: { type: 'string' }, 'section-address': { type: 'string', multiple: true }, 'replace-entry': { type: 'string' }, 'dump-section': { type: 'boolean', default: false }, overwrite: { type: 'string' }, 'link-after': { type: 'string' }, 'link-field': { type: 'string' }, 'replace-node': { type: 'string' }, 'replace-record': { type: 'string' }, keep: { type: 'string' }, near: { type: 'string' }, layer: { type: 'string' }, all: { type: 'boolean' }, pos: { type: 'string' }, heading: { type: 'string' }, scale: { type: 'string' }, over: { type: 'string' }, 'allow-scripted': { type: 'boolean' }, threshold: { type: 'string' }, min: { type: 'string' }, zoom: { type: 'string' }, box: { type: 'string' }, region: { type: 'string' }, validate: { type: 'boolean' }, port: { type: 'string' }, open: { type: 'boolean' }, read: { type: 'string', multiple: true }, 'insert-before': { type: 'string' }, 'no-refcounts': { type: 'boolean', default: false }, 'dump-anchor': { type: 'string' }, width: { type: 'string' }, height: { type: 'string' }, meshes: { type: 'boolean', default: false }, eye: { type: 'string' }, target: { type: 'string' },
};
