...
export function syntheticLevel({ placementType = 77, modelType = 12 } = {}) {
  ...
  return buildIgz({ types: Array.from({ length: 120 }, (_, i) => 't' + i), strings, objects: [
    { type: placementType, size: P, fields: [{ at: 0x08, u32: str(0) }, { at: 0x24, f32: 10 }, { at: 0x28, f32: 2 }, { at: 0x2c, f32: -3 }, { at: 0x34, f32: 90 }, { at: 0xb8, f32: 100 }, { at: MODEL_FIELD, obj: 4 }] },
    { type: placementType, size: P, fields: [{ at: 0x08, u32: str(2) }, { at: 0x24, f32: 20 }, { at: 0x28, f32: 2 }, { at: 0x2c, f32: 5 }, { at: 0x34, f32: 0 }, { at: 0xb8, f32: 100 }, { at: MODEL_FIELD, obj: 4 }] },
    ...
    { type: placementType, size: P, fields: [{ at: 0x08, u32: str(0) }, { at: 0x24, f32: 30 }, { at: 0x28, f32: 2 }, { at: 0x2c, f32: 7 }, { at: 0x34, f32: 0 }, { at: 0xb8, f32: 100 }, { at: MODEL_FIELD, obj: 4 }] },
...
export function syntheticFixups(built) {
  ...
  return {
    ...
    head_pointer_words: built.headPointerWords ?? [], id_words: [], cross_pointer_words: [],
  };
}
